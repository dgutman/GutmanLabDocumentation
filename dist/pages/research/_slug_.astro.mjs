...
const $$slug = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<a${addAttribute(link("/research/"), "href")}>&larr; Back to Research</a> <h1 class="page-title">${title}</h1> ${html ? renderTemplate`<div class="content-recovered">${unescapeHTML(html)}</div>` : renderTemplate`<p class="placeholder">
No recovered content for this topic yet. This is a holding page.
</p>`}` })}`;
}, "/tmp/GutmanLabDocumentation/src/pages/research/[slug].astro", void 0);
const $$file = "/tmp/GutmanLabDocumentation/src/pages/research/[slug].astro";
const $$url = "/GutmanLabDocumentation/research/[slug]/";
